...
def generateMapper(url, corpus, story_html):
  """Parse BBC HTML File
...
if __name__ == "__main__":
  ...
  map_webarxiv_bbcid_file = "data/xsum/XSum-WebArxiveUrls-BBCids.txt"
  ...
  for bbcid in bbcids_dict:
    ...
    # url, corpus, htmldata
    res = generateMapper(webarxivid, "bbc", htmldata)
    if res is None:
      print('res is none')
      continue

    story_title, story_introduction, story_restcontent = res
